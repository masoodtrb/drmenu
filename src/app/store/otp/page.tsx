...
import { Store, ArrowLeft, CheckCircle, Clock, RefreshCw } from 'lucide-react';
                ...
                <CardHeader className="text-center space-y-4">
                    ...
                    <div>
                        ...
                        {username ? (
                            ...
                            <form onSubmit={handleUsernameSubmit(onSubmitUsername)} className="mt-4 space-y-4">
                                <div className="space-y-2">
                                    ...
                                    {usernameErrors.username && (
                                        <p className="text-sm text-red-600 dark:text-red-400">{usernameErrors.username.message}</p>
                                    )}
                                </div>
                                <Button
                                    type="submit"
