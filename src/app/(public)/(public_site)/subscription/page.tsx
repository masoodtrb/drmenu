...
export default function SubscriptionPage() {
    ...
    const plans = plansData?.plans.filter((plan: any) => plan.interval === selectedInterval) || [];
    ...
    const getPlanIcon = (planName: string) => {
        if (planName.includes("Enterprise")) return <Crown className="h-6 w-6 text-yellow-500" />;
        if (planName.includes("Professional")) return <Star className="h-6 w-6 text-blue-500" />;
            ...
            <div className="container mx-auto px-4 py-12">
                    ...
                    <div className="flex justify-center mb-8">
                        <div className="bg-white rounded-lg p-1 shadow-md">
                            <button
                                ...
                                className={`px-6 py-2 rounded-md font-medium transition-colors ${selectedInterval === "MONTHLY"
                            ...
                            <button
                                ...
                                className={`px-6 py-2 rounded-md font-medium transition-colors ${selectedInterval === "YEARLY"
                                    ? "bg-blue-600 text-white"
                                    : "text-gray-600 hover:text-gray-900"
                                    }`}
                            >
                ...
                <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
                    {plans.map((plan: any) => (
                        <Card
                            key={plan.id}
                            className={`relative overflow-hidden transition-all duration-300 hover:shadow-xl ${plan.isDefault
                        ...
                        >
                            ...
                            <CardContent className="space-y-6">
                                ...
                                {/* Subscribe Button */}
                                <Button
                                    className={`w-full py-3 text-lg font-semibold ${plan.isDefault
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                        <div className="bg-white rounded-lg p-6 shadow-md">
                            ...
                            <p className="text-gray-600">
                                بله، شما می‌توانید در هر زمان طرح خود را ارتقا یا تنزل دهید. تغییرات بلافاصله اعمال می‌شود.
                            </p>
                        </div>
                        <div className="bg-white rounded-lg p-6 shadow-md">
                            <h3 className="text-lg font-semibold mb-3">
                            ...
                            <p className="text-gray-600">
                                بله، شما می‌توانید در هر زمان اشتراک خود را لغو کنید. تا پایان دوره پرداخت شده، خدمات ادامه خواهد داشت.
                            </p>
                        </div>
                        <div className="bg-white rounded-lg p-6 shadow-md">
                            <h3 className="text-lg font-semibold mb-3">
                            ...
                            <p className="text-gray-600">
                                بله، تمام طرح‌ها شامل پشتیبانی فنی هستند. طرح‌های حرفه‌ای و سازمانی شامل پشتیبانی اولویت‌دار می‌باشند.
                            </p>
                        </div>
                        <div className="bg-white rounded-lg p-6 shadow-md">
                            <h3 className="text-lg font-semibold mb-3">
                            ...
                            <p className="text-gray-600">
                                بله، شما می‌توانید ۷ روز به صورت رایگان از تمام ویژگی‌ها استفاده کنید.
                            </p>
                        </div>
                    </div>
                </div>
