...
export default function AdminSubscriptionPage() {
    ...
    const { data: plansData, isLoading, refetch } = trpc.subscription.listPlans.useQuery({
        limit: 100
    });
    ...
    return (
        <div className="container mx-auto px-4 py-8">
            ...
            <div className="flex justify-between items-center mb-8">
                <div>
                    <h1 className="text-3xl font-bold text-gray-900">مدیریت طرح‌های اشتراک</h1>
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                    <Card>
                        <CardHeader className="pb-2">
                            <CardTitle className="text-sm font-medium text-gray-600">کل طرح‌ها</CardTitle>
                        </CardHeader>
                        <CardContent>
                    ...
                    <Card>
                        <CardHeader className="pb-2">
                            <CardTitle className="text-sm font-medium text-gray-600">طرح‌های فعال</CardTitle>
                        </CardHeader>
                        <CardContent>
                    ...
                    <Card>
                        <CardHeader className="pb-2">
                            <CardTitle className="text-sm font-medium text-gray-600">اشتراک‌های فعال</CardTitle>
                        </CardHeader>
                        <CardContent>
                            <div className="text-2xl font-bold">{statsData.subscriptions.active}</div>
                        </CardContent>
                    </Card>
                    <Card>
                        <CardHeader className="pb-2">
                            <CardTitle className="text-sm font-medium text-gray-600">درآمد ماهانه</CardTitle>
                        </CardHeader>
                        <CardContent>
                            <div className="text-2xl font-bold">
                                {new Intl.NumberFormat("fa-IR").format(statsData.revenue.monthly)} تومان
                            </div>
                        </CardContent>
                    </Card>
                </div>
                            ...
                            <div className="flex justify-between items-start">
                                <div>
                                    <CardTitle className="flex items-center gap-2">
                                        {plan.name}
                                        {plan.nameFa && (
                                            <span className="text-sm text-gray-500">({plan.nameFa})</span>
                                        )}
                                        {plan.isDefault && (
                                    ...
                                    <CardDescription>
                                        {plan.description}
                                        {plan.descriptionFa && (
                                            <div className="text-sm text-gray-500 mt-1">{plan.descriptionFa}</div>
                                        )}
                                    </CardDescription>
                                </div>
                        ...
                        <CardContent>
                            <div className="grid grid-cols-2 md:grid-cols-6 gap-4 text-sm">
                                <div>
                                    ...
                                    <div className="text-gray-500">{plan.interval === "MONTHLY" ? "ماهانه" : "سالانه"}</div>
                                </div>
                                <div>
